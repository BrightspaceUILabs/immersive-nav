...
const sauceLabsCapabilities = {
	name: '@brightspace-ui-labs/immersive-nav unit tests',
	// eslint-disable-next-line no-undef
	build: `@brightspace-ui-labs/immersive-nav ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
